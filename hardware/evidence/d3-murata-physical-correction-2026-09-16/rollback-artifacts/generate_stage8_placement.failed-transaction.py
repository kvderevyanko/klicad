...
def main() -> None:
    ...
    c3 = add_footprint(board, "Murata_GRM21BR61A226ME44_2012Metric", "C3", "GRM21BR61A226ME44", 70.9, 59.225, 180)
    ...
    c5 = add_footprint(board, "Murata_GRM188R61A106MAAL_1608Metric", "C5", "GRM188R61A106MAAL", 24.0, 48.0)
