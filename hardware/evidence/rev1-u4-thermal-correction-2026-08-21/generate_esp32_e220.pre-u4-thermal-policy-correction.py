...
items += [
    ...
    note("U4 LAYOUT REQUIREMENT: PAD2/TAB DIRECT TO >=20x20mm F.Cu AUX_3V3 + >=20x20mm B.Cu AUX_3V3, >=4 x 0.60/0.30mm vias within 3mm; pcb_layout_dfm must verify actual thermal result.", 155, 290),
