...
EVIDENCE="$ROOT/hardware/evidence/u3-full-physical-audit-2026-09-15"
RELEASE="$ROOT/hardware/releases/rev1-q1-u3-footprint-correction-2026-09-15"
ZIP="$ROOT/hardware/releases/ESP32-E220-Carrier-Rev1-Q1-U3-Footprint-Correction-2026-09-15.zip"
FAB="$RELEASE/fabrication"
ASM="$RELEASE/assembly"
DOC="$RELEASE/documentation"
DIAG="$RELEASE/diagnostics"

EXPECTED_PCB_SHA="ef7cc377eb670115295f39cbd963e8910f2f4047cf5d740728abd09e1e4f25ea"
...
kicad-cli pcb export ipcd356 \
  --output "$FAB/ESP32-E220-Carrier-Rev1-Q1-U3-Footprint-Correction.ipc356" \
  "$BOARD"
...
python3 "$EVIDENCE/audit_q1_u3_corrected_release.py"

(
  cd "$ROOT/hardware/releases"
  zip -X -r "$ZIP" "rev1-q1-u3-footprint-correction-2026-09-15"
)
