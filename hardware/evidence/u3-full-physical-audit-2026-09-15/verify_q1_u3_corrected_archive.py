#!/usr/bin/env python3
"""Read-only integrity check of the final Q1+U3-corrected release ZIP."""
...
ARCHIVE = HARDWARE / "releases/ESP32-E220-Carrier-Rev1-Q1-U3-Footprint-Correction-2026-09-15.zip"
PREFIX = RELEASE.name + "/"
...
def main() -> int:
    ...
    result = {
        "gate": "Q1-U3-CORRECTED RELEASE ARCHIVE INTEGRITY",
        ...
        "physical_footprint_audit_disposition": audit.get("physical_footprint_audit_disposition"),
